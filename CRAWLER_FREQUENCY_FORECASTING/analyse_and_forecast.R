analyse_and_forecast <- function(my_log_file_path)
{
  ...
  my_results_df <- data.frame(ARIMA_Prediction =arima_prediction, Constant_Prediction = constant_prediction, Linear_Prediction = linear_prediction, Entry = googlebotmobile_visits, Time_Periods = 1:NROW(prediction))
